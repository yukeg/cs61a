    ...
    def nearest_bee(self, beehive):
        ...
        for _ in range(self.min_range):
            if cur:
                ...
                return None
        while cur is not beehive and cum <= self.max_range:
            if cur.bees:
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.imposter == True:
            ...
            cur = self.place.exit
            while cur:
                if cur.ant and cur.ant.buffed == False:
                    cur.ant.damage = 2*cur.ant.damage
                    cur.ant.buffed = True
                cur = cur.exit
        # END Problem EC
...
class LaserAnt(ThrowerAnt):
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        quirk = self.damage - self.insects_shot*0.05 - distance*0.2
        return quirk
        # END Problem Optional 5
