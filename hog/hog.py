...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(num_rolls):
        ...
        if dice_outcome == 1:
            turn_pig = True
        turn_outcome += dice_outcome
    return 1 if turn_pig else turn_outcome
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def say(score0, score1, high = running_high):
        if who == 0:
...
def make_averaged(original_function, trials_count=1000):
    ...
    def averaging(*args):
        ...
        for i in range(trials_count):
            summed += original_function(*args)
        return float(summed)/trials_count
    return averaging
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for num_dice in range(1, 11):
        ...
        scoring = averaged_roll_dice(num_dice, dice)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    return 0 if extra_turn(score, opponent_score) else bacon_strategy(score, opponent_score, cutoff, num_rolls)  # Replace this statement
    # END PROBLEM 11
